...
// configuration step. It creates a namespace called `test_cpp_best_practives`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", test_cpp_best_practives::cmake::project_name, test_cpp_best_practives::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", test_cpp_best_practives::cmake::project_version);
      return EXIT_SUCCESS;
    }
